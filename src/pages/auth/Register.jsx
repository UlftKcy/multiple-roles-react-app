    ...
    <Container minH="100vh" display="flex" justifyContent="center" alignItems="center" my={{ base: '14', md: '0' }}>
      <Box bg="white" p={10} rounded="md" w="100%">
          ...
          <VStack spacing={5}>
            <FormControl>
              ...
              <Input
                ...
                style={{ borderColor: `${formik.touched.first_name && formik.errors.first_name ? "red" : ""}` }}
              />
            ...
            <FormControl>
              ...
              <Input
                ...
                style={{ borderColor: `${formik.touched.last_name && formik.errors.last_name ? "red" : ""}` }}
              />
            ...
            <FormControl>
              ...
              <Input
                ...
                style={{ borderColor: `${formik.touched.occupation && formik.errors.occupation ? "red" : ""}` }}
              />
        ...
        <Box display="flex" justifyContent="center" alignItems="center" my={4}>
          ...
          <Link fontSize="lg" fontWeight="extrabold" as={ReachLink} to="/login">Login</Link>
        </Box>
      </Box>
    </Container>
  )
